...
const defaultToolbarButtons: ToolbarButton[] = [
  ...
  { type: 'left', icon: 'L', label: 'Left', group: 'alignment' },
  { type: 'center', icon: 'C', label: 'Center', group: 'alignment' },
  { type: 'right', icon: 'R', label: 'Right', group: 'alignment' },
  { type: 'justify', icon: 'J', label: 'Justify', group: 'alignment' },
